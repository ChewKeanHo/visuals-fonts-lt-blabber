# LyonsType's Blabber (`LT Blabber`) Font | (Holloway) Chew, Kean Ho's Creative Visuals
...
This font is ideal for most general use like poster title, poster text, movie
title, movie notice headings, movie notice text, body headings, and body text.
...
```
Title: LyonsType's Blabber (LT Blabber) Font
Creators: The LyonsType's Blabber Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-lt-blabber
UUID: 211863AA-C00F-4363-B3EA-7B8424060B2E
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-04-05
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-lt-blabber
```
